...
public class EmployeController implements Serializable {
    ...
    @EJB
    private session.EmploiprecedentFacade ejbEmploiFacade;
    ...
    public void setEjbEmploiFacade(EmploiprecedentFacade ejbEmploiFacade) {
        this.ejbEmploiFacade = ejbEmploiFacade;
    }
    ...
    public PaginationHelper getPagination() {
        if (pagination == null) {
            pagination = new PaginationHelper(ejbFacade.findAll().size()) {
